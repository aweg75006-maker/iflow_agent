...
Provides extensible trace formatting for action and observation records.
"""
...
# ============== Built-in Tool Formatters ==============

class GoogleSearchActionFormatter(ActionFormatter):
    """GoogleSearchAction formatter."""
...
class ExtractUrlActionFormatter(ActionFormatter):
    """ExtractUrlContentAction formatter."""
...
class SuccessObservationFormatter(ObservationFormatter):
    """Formatter for observations containing success and output/error fields."""
...
def create_default_trace_formatter() -> TraceFormatter:
    """Create the default IFlow tool trace formatter."""
    return (
        TraceFormatter()
